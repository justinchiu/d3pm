...
def _transformer(
    ...
    if attention_dropout_rate is not None:
        configs["models.build_transformer_config.attention_dropout_rate"] = (
...
def diffusion():
    ...
    params = {
        "run_experiment.task_name": "diffusion",
        "run_experiment.model_cls": "@CategoricalDiffusionModel",
        "run_experiment.max_train_steps": 10000,
        "CategoricalDiffusionModel.use_timestep_embeddings": True,
        "CategoricalDiffusionModel.use_film_layers": False,
        "run_experiment.batch_size_per_device": 8,
        "discrete_diffusion_loss_fn.predict_x0": True,
        "discrete_diffusion_predict_fn.predict_x0": True,
        "discrete_diffusion_loss_fn.compute_elbo": True,
        "run_experiment.num_predict_steps": 1,
        "run_experiment.num_eval_steps": 10,
        "run_experiment.validate_every": 25000,
        "create_discrete_diffusion.update_every": 200,
        "trainers.Trainer.learning_rate_fn": "@learning_rate/utils.create_learning_rate_scheduler",
        "learning_rate/utils.create_learning_rate_scheduler.factors": "linear_warmup_from * constant",
        "learning_rate/utils.create_learning_rate_scheduler.base_learning_rate": 2e-4,
        "learning_rate/utils.create_learning_rate_scheduler.warmup_steps": 5000,
        "trainers.Trainer.grad_clip": 0.25,
    }
